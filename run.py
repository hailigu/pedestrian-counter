...
FLAGS.demo = "3.h264" # video file to use, or if camera just put "camera"
FLAGS.model = "darkflow/cfg/yolo-person.cfg" # tensorflow model
FLAGS.load = "darkflow/bin/yolo-person_19.weights" # tensorflow weights
FLAGS.threshold = 0.25 # threshold of decetion confidance (detection if confidance > threshold )
FLAGS.gpu = 0.9 #how much of the GPU to use (between 0 and 1) 0 means use cpu
...
FLAGS.counter = True # pedestrian counter
